...
//		/*
		...
		keybCloseSvg = new MTSvgButton(pa, MT4jSettings.getInstance().getDefaultSVGPath()
						+ "keybClose.svg");
		//Transform
...
//		sp.setLockPriority(0.8f);
	...
	public MTSvgButton getKeybCloseSvg() {
		return keybCloseSvg;
	}


	public void setKeybCloseSvg(MTSvgButton keybCloseSvg) {
		this.keybCloseSvg = keybCloseSvg;
	}
