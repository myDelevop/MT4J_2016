...
//							System.out.println("Play!");
	...
	public class PlaySymbol extends MTEllipse{
	...
	public class MovieClip extends MTVideoTexture{
...
//				float delta = ae.getAnimation().getInterpolator().getCurrentStepDelta();
				...
				case AnimationEvent.ANIMATION_ENDED:
					setVisible(false);
					MTComponent parent = istance.getParent();
					parent.removeChild(istance);
					destroy();
					break;	
				default:
					break;
...
//		}
	...
	public PlaySymbol getPlaySymbol() {
		return playSymbol;
	}


	public void setPlaySymbol(PlaySymbol playSymbol) {
	...
	public void setCloseButton(MTImageButton closeButton) {
